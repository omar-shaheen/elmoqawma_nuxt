        ...
        <div class="shadow-lg border-t-2 border-fp1 rounded-lg divide-y">
          ...
          <div v-for="file in course.attachments" :key="file.id" class="py-2">
            <button v-if="course.subscribed"
              ...
              class="flex justify-between items-center text-fpDark2 dark:text-white hover:text-fp1 dark:hover:text-fp1 hover:bg-gray-50 dark:hover:bg-fpDark3 px-4 cursor-pointer w-full">
            ...
            <button @click="notOpenFile()" v-else
              class="flex justify-between items-center text-fpDark2 dark:text-white hover:text-fp1 dark:hover:text-fp1 px-4 cursor-pointer w-full">
              <div class="flex items-center gap-x-2 font-medium">
                <Icon class="size-7 -mt-1" name="solar:file-text-broken" />
                <p>{{ file.name }}</p>
              </div>
